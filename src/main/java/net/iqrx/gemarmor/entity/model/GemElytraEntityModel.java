package net.iqrx.gemarmor.entity.model;
...
public class GemElytraEntityModel<T extends LivingEntity> extends AnimalModel<T> {

    private final ModelPart rightWing;
    private final ModelPart leftWing;

    public GemElytraEntityModel(ModelPart root) {
